Fabricator(:shipment) do
  ...
  pick_up_location_zip { Faker::Address.zip_code }
  pick_up_location_phone { Faker::Address.zip_code }
  ...
  delivery_location_zip { Faker::Address.zip_code }
  delivery_location_phone { Faker::Address.zip_code }
